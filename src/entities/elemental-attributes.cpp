...
std::vector<std::vector<int>> ElementalAttributes::elementalAttributesRestraints(256, std::vector<int>(256, 1));
...
void ElementalAttributes::loadElementalAttributes() {
    ...
    elementalAttributesRestraints.assign(256, std::vector<int>(256, 1));
